...
class Event {
    ...
    static final int E_RECVD_SYN_own = 300

    static final int E_SEND_SYN_ACK_own = 310

    static final int E_RCVD_FIN_own = 330

    static final int E_SEND_FIN_ACK_own = 340

    static final int E_OPEN_own = 350

    static final int E_CLOSECON_own = 360
